...
def run_plantSim(mode, methods, batch_size):
    folder = "C:/Users/yxu59/files/winter2026/park/simulation/PhysicalData"
    ...
    for name, meta in methods.items():
        ...
        results[name] = dict(theta_hist=theta_hist, theta_var_hist=theta_var_hist, gt_theta_hist=gt_theta_hist)
    return results
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_dir", type=str, default="figs/plantSim")
